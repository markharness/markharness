...
Apply [CONTRIBUTING.md](CONTRIBUTING.md#information-placement-and-comments) when writing or reviewing comments: Code is the source for current What/How, comments preserve local Why/invariants/non-obvious constraints, ADRs record design decisions, and Git history records evolution.
