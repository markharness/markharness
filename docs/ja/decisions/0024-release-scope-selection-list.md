...
Accepted(2026-09-11、設計合意済み・未実装)。[0020](0020-execution-status-lightweight-model.md)が定める「実行結果・証跡をmarkharnessの責務から外す」方針は維持したまま、「そのリリースで何を検証対象に選んだか」だけを記録する最小の型を追加する。
