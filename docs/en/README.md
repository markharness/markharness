...
4. Detailed design of individual commands (referenced from cli-manual):
   ...
   - **[domain-application-infrastructure-layering-design.md](./design/domain-application-infrastructure-layering-design.md)** — (Status: Proposed, not implemented) Architecture design layering the CLI into Domain/Application/Infrastructure. Detailed design for the direction decided in [decisions/0009](./decisions/0009-domain-application-infrastructure-layering.md).
