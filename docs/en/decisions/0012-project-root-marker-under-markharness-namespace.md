...
- Documentation (`docs/ja/cli-manual.md`, `docs/en/cli-manual.md`, `docs/ja/knowledge-from-code.standalone.md` — the latter was consolidated into `docs/knowledge-from-code.ai.md` and deleted on 2026-09-12) references to `.markharness.toml` were updated to `.markharness/config.toml`.
