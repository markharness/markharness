...
pub enum IdentityCommand {
    ...
    /// Re-derive a Knowledge file's id:/uid: from its identity event log, filling in a missing uid: or correcting a stale id:
    Sync {
...
/// code 1. Returns normally only when `errors` is empty.
